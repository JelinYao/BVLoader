...
public:
    ...
    virtual void AddDecodeTask(UINT_PTR task_id, std_cwstr_ref video_path, 
        std_cwstr_ref mp3_path, std_cwstr_ref img_path) = 0;
...
public:
    ...
    virtual void Decode(UINT_PTR task_id, std_cwstr_ref video_path, 
        std_cwstr_ref mp3_path, std_cwstr_ref img_path) = 0;
};