...
bool QREncode::EncodeData(int nLevel, int nVersion, bool bAutoExtent, int nMaskingNo, const char* lpsSource, int ncSource)
{
	int i, j;
...
/////////////////////////////////////////////////////////////////////////////
// QREncode::GetEncodeVersion
int QREncode::GetEncodeVersion(int nVersion, const char* lpsSource, int ncLength)
{
...
/////////////////////////////////////////////////////////////////////////////
// QREncode::EncodeSourceData

bool QREncode::EncodeSourceData(const char* lpsSource, int ncLength, int nVerGroup)
{
...
/////////////////////////////////////////////////////////////////////////////
// QREncode::GetBitLength

int QREncode::GetBitLength(BYTE nMode, int ncData, int nVerGroup)
{
	int ncBits = 0;
...
/////////////////////////////////////////////////////////////////////////////
// QREncode::SetBitStream

int QREncode::SetBitStream(int nIndex, WORD wData, int ncData)
{
	int i;
...
/////////////////////////////////////////////////////////////////////////////
// QREncode::AlphabetToBinaly


BYTE QREncode::AlphabetToBinaly(unsigned char c)
{
...
/////////////////////////////////////////////////////////////////////////////
// QREncode::KanjiToBinaly


WORD QREncode::KanjiToBinaly(WORD wc)
{
...
/////////////////////////////////////////////////////////////////////////////
// QREncode::GetRSCodeWord

void QREncode::GetRSCodeWord(LPBYTE lpbyRSWork, int ncDataCodeWord, int ncRSCodeWord)
{
	int i, j;
