...
class Connection {
 public:
	...
	RestClient::Response form(const std::string& uri,
	...
	RestClient::Response upload(const std::string& uri, const std::string& file);

	RestClient::Response download(const std::string& url, const std::string &file, progress_cb cb = nullptr);
 ...
 private:
	...
	RestClient::Response performCurlRequest(const std::string& uri, const std::string &filename, progress_cb = nullptr);
};
};  // namespace RestClient
